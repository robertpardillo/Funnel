...
class Application(object):
    """
        ...
        Root class which is origin of the rest. It contains all the objects and all the instantiated data.

        It initializes CATIA's connection.
    ...
    def get_parts(self):
        ...
        :rtype: ..abstractObjects.documents.part.Part
